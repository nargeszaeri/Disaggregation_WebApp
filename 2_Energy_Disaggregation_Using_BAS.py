...
######################
    ...
    # alt.Chart(df_valves).mark_line().encode(y=selected_column)
    # st.line_chart(data=df_valves, y = selected_column)
    st.line_chart(df_valves[selected_column])
    ...
    st.line_chart(df_Clg_3['Jean Talon- Chilled Water (MJ)'])
